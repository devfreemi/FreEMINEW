...
public interface MailSenderInterface {
	...
	public void sendMFRegisterNotificationwithAOF(String mailType, String customerName, String mobile, String mailId, String bseClientID,String pan, String kycStatus, byte[] aofdata);
