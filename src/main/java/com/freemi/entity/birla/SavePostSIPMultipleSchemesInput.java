...
public class SavePostSIPMultipleSchemesInput {

	@JsonProperty("PostSIPMultipleSchemes")
	private PostSIPMultipleSchemes postSIPMultipleSchemesObject;
	
	
	
	public PostSIPMultipleSchemes getPostSIPMultipleSchemesObject() {
		return postSIPMultipleSchemesObject;
	}



	public void setPostSIPMultipleSchemesObject(PostSIPMultipleSchemes postSIPMultipleSchemesObject) {
		this.postSIPMultipleSchemesObject = postSIPMultipleSchemesObject;
	}



	public static class PostSIPMultipleSchemes {
