...
<meta property="og:title"
	content="One stop solution for your personal loan, home loan, Credit cards" />
...
<link href="<c:url value="${contextcdn}/resources/css/freeEmi2.min.css"/>" rel="stylesheet" type="text/css">
...
<script async="true" src="https://emicalculator.net/widget/2.0/js/emicalc-loader.min.js"></script>
			...
			<div class="container">
				...
				<c:if test="${REQUESTSUCCESS=='Y' }">
					<div class="alert alert-success" role="alert">
						<img
							...
							alt="Personal Loan" class="img-fluid rounded-circle"
				...
				<div class="row">
					<div class="col-md-4 col-lg-4">
						<div class="col_design2 animated bounceInLeft pt-2">
							<h5>PERSONAL LOAN</h5>
							<img
								src="<c:url value="${contextcdn}/resources/images/personal_loan.png"/>"
								alt="Personal loan" class="img-fluid rounded-circle"
								style="height: 50px; border: 1px solid #ec8439; padding: 5px;">
							...
							<div class="row topic2">
								<div class="col-md-12 col-lg-12 ">
									...
									<form:form method="POST"
										action="${pageContext.request.contextPath}/personalLoan.do"
										...
										<div class="custom-control custom-checkbox custom-checkbox-sm">
											<form:checkbox path="dndAgree" value="Y"
												class="custom-control-input" id="plagree" checked="checked "
												onclick="validateplForm();" />
											<label class="custom-control-label" for="plagree"> I have read and agreed to <a
												href="/products/terms-of-use"
							...
							<div class="text-muted text-left border-top pl-2">
								<small><strong>Loan Duration:</strong> 12 - 60 months </small> <br>
								<small><strong>Interest rate:</strong> 10.99% &amp; above</small>
								<br> <small>T&amp;C Applied</small>
							</div>
					...
					<div class="col-md-4 col-lg-4">
						<div class="col_design2 animated fadeIn  pt-2">
							<h5>HOME LOAN</h5>
							<img
								src="<c:url value="${contextcdn}/resources/images/home_loan2.png"/>"
								alt="Home Loan" class="img-fluid rounded-circle"
								style="height: 50px; border: 1px solid #1c7fd4; padding: 5px;">
							<div class="row topic2">
								<div class="col-md-12 col-lg-12">
									<form:form method="POST"
										action="${pageContext.request.contextPath}/homeLoan.do"
										commandName="homeLoan">
										<form:hidden path="requestCategory" />
										<div class="md-form"><form:input
											class="form-control form-control-sm mb-1 custom_box"
											type="text" path="name" id="hlusername" maxlength="64"
											placeholder="Your Name" onkeyup="validatehlForm()" /></div>
										...
										<div class="md-form">	<form:input
											...
											placeholder="Email Id (Optional)" onkeyup="validatehlForm()" /></div>

										<div class="md-form"><form:input
											class="form-control form-control-sm mb-1 custom_box"
											type="text" path="location" id="hluserlocation"
											maxlength="16" placeholder="City" onkeyup="validatehlForm()" /></div>
										
										<div class="custom-control custom-checkbox custom-checkbox-sm">
											<form:checkbox path="dndAgree" value="Y"
												class="custom-control-input" id="hlagree" checked="checked "
												onclick="validateplForm();" />
											<label class="custom-control-label" for="hlagree"> I have read and agreed to <a
												href="/products/terms-of-use">Terms of Use</a></label>
										</div>
							...
							<div class="text-muted text-left border-top pl-2">
								<small><strong>Loan Duration:</strong> Upto 30 yrs </small> <br>
								<small><strong>Interest rate:</strong> 8.35% &amp; and
									above <sup>*</sup></small> <br> <small>T&amp;C Applied</small>
							</div>

						</div>
					</div>
					<div class="col-md-4 col-lg-4">
						<div class="col_design2 animated bounceInRight  pt-2">
							<h5>CREDIT CARD</h5>
							<img
								src="<c:url value="${contextcdn}/resources/images/credit_card.png"/>"
								alt="Credit card" class="img-fluid rounded-circle"
								style="height: 50px; border: 1px solid #d43b2c; padding: 5px;">
							<div class="row topic2">
								<div class="col-md-12 col-lg-12">
									<form:form method="POST"
										action="${pageContext.request.contextPath}/creditCard.do"
										...
										<div class="md-form">	<form:input
											...
											placeholder="Your Name" onkeyup="validateccForm()" /></div>
										...
										<div class="md-form"><form:input
											...
											data-placement="top" title="We guarantee your privacy." /></div>

										<div class="md-form"><form:input
											class="form-control form-control-sm mb-1 custom_box"
											type="text" path="email" id="ccuseremail" maxlength="64"
											placeholder="Email Id (Optional)" onkeyup="validateccForm()" /></div>

										<div class="md-form"><form:input
											class="form-control form-control-sm mb-1 custom_box"
											type="text" path="location" id="ccuserlocation"
											maxlength="16" placeholder="City" onkeyup="validateccForm()" /></div>
									
										<div class="custom-control custom-checkbox custom-checkbox-sm">
											<form:checkbox path="dndAgree" value="Y"
												class="custom-control-input" id="ccagree" checked="checked "
												onclick="validateplForm();" />
											<label class="custom-control-label" for="ccagree"> I have read and agreed to <a
												href="/products/terms-of-use">Terms of Use</a></label>
										</div>
				...
				<div class="row animated zoonIn" style="margin-top: 20px;">
					<div class="col-md-4 col-lg-4" style="margin: auto;">
						<div class="button_eli animated fadeIn">
							<a href="/products/register" class="btn btn-block #fff8e1 amber lighten-5">
			...
			<div class="container animated slideInUp">
				...
				<div class="row" style="margin-top: 2rem;">
					<div class="col-6 col-sm-3 col-lg-3">
						<img
							src="<c:url value="${contextcdn}/resources/images/partnerlogo/loans/bajaj-finserv.jpg"/>"
							class="img-fluid" alt="Bajaj Finserv"
							style="margin-bottom: 2rem;">
					</div>
					<div class="col-6 col-sm-3 col-lg-3">
						<img
							src="<c:url value="${contextcdn}/resources/images/partnerlogo/loans/fullerton.jpg"/>"
							class="img-fluid" alt="Fullerton India"
							style="margin-bottom: 2rem;">
					</div>
					<div class="col-6 col-sm-3 col-lg-3">
						<img
							src="<c:url value="${contextcdn}/resources/images/partnerlogo/loans/hdfc.jpg"/>"
							class="img-fluid" alt="HDFC bnk" style="margin-bottom: 2rem;">
					</div>
					<div class="col-6 col-sm-3 col-lg-3">
						<img
							src="<c:url value="${contextcdn}/resources/images/partnerlogo/loans/icici.jpg"/>"
							class="img-fluid" alt="ICICI bank" style="margin-bottom: 2rem;">
					</div>
					<div class="col-6 col-sm-3 col-lg-3">
						<img
							src="<c:url value="${contextcdn}/resources/images/partnerlogo/loans/idfc.jpg"/>"
							class="img-fluid" alt="IDFC bank" style="margin-bottom: 2rem;">
					</div>
					<div class="col-6 col-sm-3 col-lg-3">
						<img
							src="<c:url value="${contextcdn}/resources/images/partnerlogo/loans/indiabulls.jpg"/>"
							class="img-fluid" alt="Indiabulls" style="margin-bottom: 2rem;">
					</div>
					<div class="col-6 col-sm-3 col-lg-3">
						<img
							src="<c:url value="${contextcdn}/resources/images/partnerlogo/loans/indusind.jpg"/>"
							class="img-fluid" alt="IndusInd" style="margin-bottom: 2rem;">
					</div>
					<div class="col-6 col-sm-3 col-lg-3">
						<img
							src="<c:url value="${contextcdn}/resources/images/partnerlogo/loans/kotak.jpg"/>"
							class="img-fluid" alt="Kotak Mahindra Bank"
							style="margin-bottom: 2rem;">
					</div>
				</div>
			</div>
						...
						<div id="accordion">
							<div class="card">
								<div class="card-header" id="headingOne">
									<h5 class="mb-0">
										<button class="btn btn-link" data-toggle="collapse"
											...
											<span class="loan_header">PERSONAL LOAN AT A GLANCE <i
								...
								<div id="collapseOne" class="collapse show"
									...
									<div class="card-body"
										style="max-height: 400px; overflow: scroll; color: #727374; font-size: 13px;">

										<p>Personal Loan bridges the gap between what we have and
											what we need.</p>
										<p>Personal Loan is an unsecured loan.</p>

										<h5 class="loan_header_topic">TO DECIDE: WHETHER TO TAKE
											LOAN OR NOT?</h5>
										<p>
											One need to first figure out whether to meet the need of fund
											from our savings or to take up a personal loan.<br />You
											need to consider thoroughly the Pros and Cons of both
											Personal Loan and Money taken from<br />Savings.<br />If
											you decide to take out money from savings, you need to Plan
											Your Savings, so that, you can manage your good expenses <a
												href="https://www.freemi.in/products/registry-mutual-funds">Registry
												Planner</a><br />But, if you decide to opt for a Personal Loan,
											you need to get full information on it.
										</p>

										<h5 class="loan_header_topic">Details regarding PERSONAL
											LOAN.</h5>

										<p>
											Here, we provide full information regarding the process of
											initializing and<br />completing the process of Personal
											Loan.
										</p>
										...
										<ul>
											<li>You need to have a good credit history and CIBIL
												score.</li>
											<li>The Interest rate is set under the regulation of
												RBI, which is quite high.</li>
										...
										<p>Check the eligibility criteria by talking to a personal
											finance executive.</p>
										<p>Following are the criterias which are essential to
											follow to approve the process of personal loan:</p>
										<ul style="list-style-type: square;">
											...
											<li><strong>Minimum Income-</strong> Rs.20,000
												(excluding incentives)</li>
											<li><strong>Maximum Loan amount-</strong> Rs 50 lakhs
												(differs accordingly)</li>
											<li><strong>Loan Tenure-</strong> Min 6 months and Max
												60 months</li>
										...
										<p>After the approval of the loan, bank personnel
											officials will contact you for disbursement agreement/loan
											agreement.</p>
