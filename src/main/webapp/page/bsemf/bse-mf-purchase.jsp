		...
		<div class="row" style="margin: auto;">
			<div class="col-md-8 col-lg-8 purchase-form" style="margin: auto;">
				<form:form
					...
					alt="Investor icon" style="height: 1.5rem;">  Investor Details</h5>
					<c:if test="${GETDATA == 'S' }">
					...
					alt="Cart icon" style="height: 1.5rem;">  Purchase Details</h5>
					<div class="form-group row">
						<label for="folio" class="col-sm-3 col-form-label">Folio
							No.</label>
						<div class="col-sm-9">
								<form:select path="portfolio" class="form-control form-control-sm">
					...
					<div class="custom-control custom-checkbox" style="height: 150px; overflow-y: auto;">
						<input type="checkbox" class="custom-control-input"
							id="agreecheck1"> <label class="custom-control-label"
							for="agreecheck1" style="font-size: 11px;text-align: justify;"> I/We have read and understood the
							contents of the Scheme Information Document(s), Key Information
							Memorandum and Addenda issued for the respective scheme(s). I/We
							hereby apply to the Trustee of Mutual Fund and agree to abide by
							terms and conditions, rules and regulation of the relevant
							scheme(s) / Mutual Fund. I/We have neither received nor been
							induced by any rebate or gifts, directly or indirectly in making
							this investment. The ARN holder has disclosed to me/us all the
							...
							<br><br>
							Any other advisory charges shall be paid directly by the investor
							to the ARN Holder (AMFI registered Distributor) based on the
							investors' assessment of various factors including the service
							rendered by the ARN Holder. In case of existing investor where
							investment amount is Rs.10,000/- or more and your Distributor has
							opted to receive Transaction Charges, Rs.100/- will be deducted
							from the purchase amount and paid to the Distributor. Units will
							be issued against the balance amount invested. I/We confirm that
							payment for this transaction has been done through my/own bank
							account number which is registered in the folio and no third
							party account is used for such payments. In case of any
							non-compliance, I/We authorize you to refund the said amount to
							the account where it is debited and will liable for any
							consequences arising thereof. </label>
					</div>
