...
<link href="<c:url value="https://resources.freemi.in/loans/resources/css/styling-header.css"/>" rel="stylesheet" type="text/css">
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent-4">
    <ul class="navbar-nav ml-auto">
     <li class="nav-item dropdown" style="display: -webkit-inline-box;">
      <img data-src="<c:url value="${contextcdn}/resources/images/freemi_icon1.png"/>"
					alt="Loans icon" class="img-fluid lazy d-block d-sm-none" style="height: 30px;">
      ...
      <li class="nav-item dropdown" style="display: -webkit-inline-box;">
      <img data-src="<c:url value="${contextcdn}/resources/images/registry.png"/>"
					alt="Mutual Funds" class="img-fluid lazy d-block d-sm-none" style="height: 30px;">
        <a class="nav-link dropdown-toggle" id="navbarDropdownMenuLink-555" data-toggle="dropdown" aria-haspopup="true"
          aria-expanded="false">Mutual Funds
        </a>
        <div class="dropdown-menu dropdown-secondary" aria-labelledby="navbarDropdownMenuLink-555">
         <!--  <a class="dropdown-item" href="/products/mutual-funds/top-performing">Top Performing Funds</a> -->
          <a class="dropdown-item" href="https://www.freemi.in/products/mutual-funds/funds-explorer">Funds Explorer</a>
        </div>
      </li>
       <li class="nav-item dropdown" style="display: -webkit-inline-box;">
      <img data-src="<c:url value="${contextcdn}/resources/images/credit-card-ico.svg"/>"
					alt="Cards" class="img-fluid lazy d-block d-sm-none" style="height: 30px;">
        <a class="nav-link dropdown-toggle" id="navbarDropdownMenuLink-555" data-toggle="dropdown" aria-haspopup="true"
      ...
      <li class="nav-item dropdown" style="display: -webkit-inline-box;">
      <img data-src="<c:url value="${contextcdn}/resources/images/fsecure.png"/>"
					alt="Insurace" class="img-fluid lazy d-block d-sm-none" style="height: 30px;">
        <a class="nav-link dropdown-toggle" id="navbarDropdownMenuLink-555" data-toggle="dropdown" aria-haspopup="true"
       ...
       <li class="nav-item dropdown" style="display: -webkit-inline-box;">
      <img data-src="<c:url value="${contextcdn}/resources/images/calculator.png"/>"
					alt="Calculator" class="img-fluid lazy d-block d-sm-none" style="height: 30px;">
        <a class="nav-link dropdown-toggle" id="navbarDropdownMenuLink-555" data-toggle="dropdown" aria-haspopup="true"
