...
<link href="<c:url value="${contextcdn}/resources/css/footer.css"/>"
	rel="stylesheet" type="text/css">
<div class="footer">
	<div class="container">
		<div class="row">
			<div class="col-12 col-md-11 col-lg-11 pt-4 mx-auto">
				<div class="col-12 col-md-3 col-lg-3 footer-divider float-left px-0">
					...
					<i
						class="col-1 col-md-1 col-lg-1 fa fa-phone fa-rotate-90 float-left p-0 ml-0 footer-divider"
						aria-hidden="true" style="margin-top: 4px;"></i>
					<p class="mb-1">
					...
					<img
						...
						class="img-fluid float-left mt-1" alt="Whatsapp" style="height: 16px;">
					<p class="mb-1">
						<span class="sub-title pl-1">Whatsapp: </span><a
							href="https://api.whatsapp.com/send?phone=918697843404&text=Hey%20there!%20I%20need%20help%20with%20loans.&source=&data="
							class="footer-link-style"> +91-8697843404</a>
					</p>
				</div>
				<div
				...
				<div
					...
					<ul class="footer-listing pl-0 ml-0">
						...
						<li><a href="${pageContext.request.contextPath}/career/"
		...
		<div
			...
			<span class="copyright-content-style" style="color: #fffefe;"><br> &copy; 2018
				freemi.in. All rights reserved</span>
		</div>
	</div>
</div>
